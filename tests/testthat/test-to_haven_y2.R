...
test_that("to_haven_y2 errors on numeric vars", {
  expect_snapshot(
    error = TRUE,
    responses4 |>
      dplyr::mutate(
...
test_that("to_haven_y2 works on character vars", {
  # Original
...
test_that("to_haven_y2 works on factor vars", {
  # Original
...
test_that("to_haven_y2 works on haven_labelled vars", {
  expect_snapshot(
    responses4 |>
      dplyr::mutate(
